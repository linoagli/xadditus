...
import com.linoagli.java.xadditus.controllers.Main;
...
public class NirCmdHelper { // TODO: understand and optimize this class
    public static String get() throws URISyntaxException, ZipException, IOException {
        final URI uri = getJarURI();
        final URI exe = getFile(uri, "nircmd.exe");
        return exe.getPath();
    }
