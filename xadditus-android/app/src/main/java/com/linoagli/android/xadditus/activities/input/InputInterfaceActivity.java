 ...
 */
package com.linoagli.android.xadditus.activities.input;
...
public class InputInterfaceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(Runtime.INSTANCE.getConnectionsManager().getDevice().name);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.menuItemDisconnect) {
            Runtime.INSTANCE.getConnectionsManager().stopService();
